...
class CreateExpediaActivepropertylistTable extends Migration
{
    /**
     * @var string
     */
    ...
    /**
     * CreateExpediaActivepropertylistTable constructor.
     */
    public function __construct()
    {
        $this->tableName = config('expedia.table_prefix') . 'activepropertylist';
    }
	...
	public function up()
	{
		Schema::create($this->tableName, function(Blueprint $table)
		{
			...
			$table->integer('RegionID')->nullable()->index('activeproperties_regionid');
			...
			$table->index(['Latitude','Longitude'], 'activeproperties_geoloc');
		});
	}
